...
class Message {
  ...
  factory Message.fromJson(Map<String, dynamic> json) {
    final senderData =
        json['senderId'] is Map<String, dynamic> ? json['senderId'] as Map<String, dynamic> : null;
    ...
    return Message(
      ...
      readBy: (json['readBy'] as List? ?? [])
          .whereType<Map>()
          .map((r) => ReadReceipt.fromJson(Map<String, dynamic>.from(r)))
          .toList(),
      deliveredTo: (json['deliveredTo'] as List? ?? [])
          .whereType<Map>()
          .map((d) => DeliveredReceipt.fromJson(Map<String, dynamic>.from(d)))
          .toList(),
